...
var Coordenada = /** @class */ (function () {
    ...
    Coordenada.prototype.obtenerAleatorio = function (numero) {
        return Math.round(Math.random()) * numero;
    };
    Coordenada.prototype.obtenerCoordenadaAleatoria = function () {
        var coordenada = new Coordenada(this.obtenerAleatorio(7), this.obtenerAleatorio(11));
        return coordenada;
    };
