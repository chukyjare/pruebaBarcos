...
export class Coordenada {
  ...
  public obtenerAleatorio(numero: number): number{
   return Math.round(Math.random())*numero;
  }

  public obtenerCoordenadaAleatoria(): Coordenada{
    let coordenada= new Coordenada(this.obtenerAleatorio(7), this.obtenerAleatorio(11));
    return coordenada;
  }
